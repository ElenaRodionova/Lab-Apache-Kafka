...
while True: 
    data_1 = dataset.sample(frac=random.uniform(0.0001, 0.001)).to_dict() 
    data_2 = dataset.sample(frac=random.uniform(0.0001, 0.001)).to_dict()
    data_3 = dataset.sample(frac=random.uniform(0.0001, 0.001)).to_dict() 
    ...
    time.sleep(30 + random.uniform(-5.0, 5.0)) 